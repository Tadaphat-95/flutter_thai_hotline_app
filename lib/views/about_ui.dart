      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('รหัสนักศึกษา: 6752410028', style: GoogleFonts.kanit(fontSize: 16)),
            Text('ชื่อ-สกุลนักศึกษา: นายธาดาภัทร ธาราธราดล', style: GoogleFonts.kanit(fontSize: 16)),
            Text('อีเมลนักศึกษา: s6752410028@sau.ac.th', style: GoogleFonts.kanit(fontSize: 16)),
